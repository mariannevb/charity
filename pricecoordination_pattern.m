function [ LOCATION,OCCURRENCE,MAGNITUDE ] = pricecoordination_pattern( INDICATOR,LEVEL,CONDITIONAL )
%
%   pricecoordination_pattern
%   This is the function that calculate occurence, frequency, magnitude
%   of each possible price change pattern within each group
%
%   INPUT:
