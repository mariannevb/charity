...
local pathname="C:\Users\BaxterMarianne\Dropbox (BOSTON UNIVERSITY)\2018IKEA_MB\xu\charity\"
qui do "C:\Users\BaxterMarianne\Dropbox (BOSTON UNIVERSITY)\2018IKEA_MB\xu\charity\/input/header.do"
ssc install tabout

* ------------------------------------------------------------------------------
* INITIALIZATION
* ------------------------------------------------------------------------------
* this file has log changes in variables "pcdlp" instead of pchange, etc.
use "./data/ikea_fill_dlp_2018.dta", clear
drop if flag>0
...
keep y ccode2 age price_decile ijtotal pcf pc_pennyf pchangef pchange_pennyf pcdlpf pcdlp_pennyf
...
gen pcdlpf100=100*pcdlpf
la var pcdlpf100 "pcdlp in percentages"
